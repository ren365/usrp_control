...
%     rxWaveform = rxWaveform + noise;
    ...
    rxWaveform = File2Wave("rx.bin");
%     rxWaveform = txWaveform;
%       rxWaveform = [txWaveform*10;txWaveform*10;txWaveform*10];
    ...
    plot(abs(rxWaveform(1+offset:1+offset+length(txWaveform),:)))
    return 
    rxWaveform = rxWaveform(1+offset:1+offset+length(txWaveform),:);
